...
in
{
  ...
  # Force nixpkgs.overlays to null to suppress HM evaluation warnings when useGlobalPkgs is enabled
  home-manager.sharedModules = [ { nixpkgs.overlays = lib.mkForce null; } ];
}
