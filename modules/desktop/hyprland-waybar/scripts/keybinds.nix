...
let
  keybinds = [
    ...
    }
    {
      ...
      cmd = "scripts/launcher wallpaper";
    }
    {
      key = "SUPER CTRL T";
      desc = "Select theme";
  ...
  ++ [
    # ----- Util -----
    {
      ...
      cmd = "scripts/random-wall";
    }
    {
      key = "SUPER SHIFT N";
      desc = "Open notification panel";
